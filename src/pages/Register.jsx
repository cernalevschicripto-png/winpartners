...
const T = {
  ro: {
    ...
    st3t:'După aprobare', st3d:'Primești datele de acces și codul tău Melbet pe email',
  ...
  ru: {
    ...
    sub:'Заполните форму — займёт 2 минуты. Мы проверим профиль и отправим код Melbet в течение ',
    ...
    lEmail:'Email', phEmail:'email@gmail.com',
    ...
    st3t:'После одобрения', st3d:'Получаете данные для входа и код Melbet на email',
    ...
    side3:'Персональный код Melbet за 24-48 часов',
    side4:'Личный менеджер в Telegram',
    side5:'Доступ к Melbet, 1xBet, Mostbet из одного места',
  },
  en: {
    title:'Apply for Partnership',
    sub:'Fill out the form — takes 2 minutes. We verify your profile and send your Melbet code within ',
  ...
  tr: {
    ...
    sub:'Formu doldurun — 2 dakika sürer. Profilinizi doğrulayıp Melbet kodunu ',
    ...
    lEmail:'E-posta', phEmail:'ahmet@gmail.com', lPhone:'WhatsApp / Telegram', phPhone:'+90 500 000 0000',
    ...
    side3:'24-48 saatte kisisel Melbet kodu',
    side4:'Telegram üzerinde kisisel yönetici',
    side5:'Melbet, 1xBet, Mostbet tek yerden',
  },
  de: {
    title:'Partnerschaft beantragen',
    sub:'Formular ausfüllen — dauert 2 Minuten. Wir überprüfen Ihr Profil und senden Ihren Melbet-Code innerhalb von ',
    ...
    lEmail:'E-Mail', phEmail:'max@gmail.com', lPhone:'WhatsApp / Telegram', phPhone:'+49 170 000 0000',
    ...
    st3t:'Nach Genehmigung', st3d:'E-Mail mit Zugangsdaten und Melbet-Code',
    ...
    side3:'Persönlicher Melbet-Code in 24-48 Stunden',
    side4:'Persönlicher Manager auf Telegram',
    side5:'Zugang zu Melbet, 1xBet, Mostbet von einem Ort',
  },
  pt: {
    title:'Candidatura à Parceria',
    sub:'Preencha o formulário — leva 2 minutos. Verificamos seu perfil e enviamos o código Melbet em ',
    ...
    lEmail:'Email', phEmail:'joao@gmail.com', lPhone:'WhatsApp / Telegram', phPhone:'+55 11 00000-0000',
    ...
    st3t:'Após aprovação', st3d:'Recebe email com dados de acesso e código Melbet',
    ...
    side3:'Código Melbet pessoal em 24-48 horas',
    side4:'Gerente pessoal no Telegram',
    side5:'Acesso a Melbet, 1xBet, Mostbet de um lugar',
  },
  pl: {
    title:'Złóż Wniosek o Partnerstwo',
    sub:'Wypełnij formularz — zajmuje 2 minuty. Sprawdzamy Twój profil i wysyłamy kod Melbet w ciągu ',
    ...
    lEmail:'Email', phEmail:'jan@gmail.com', lPhone:'WhatsApp / Telegram', phPhone:'+48 500 000 000',
    ...
    side3:'Osobisty kod Melbet w 24-48 godzin',
            ...
            <div style={{position:'sticky',top:80}}>
              ...
              <div style={{marginTop:28,background:'rgba(245,166,35,0.04)',border:'1px solid rgba(245,166,35,0.12)',borderRadius:10,padding:'1rem'}}>
                <div style={{display:'flex',alignItems:'center',gap:8,marginBottom:10}}>
                  ...
                  <span style={{fontSize:12,color:'#10b981',fontWeight:700}}>95% aprobare</span>
                </div>
                <div style={{fontSize:12,color:'rgba(255,255,255,0.35)',lineHeight:1.6}}>
                  Procesăm cererile în 24-48 ore. Răspuns rapid pe Telegram.
                </div>
              </div>
            </div>
          </div>
