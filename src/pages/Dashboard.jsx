              ...
              {c.comingSoon ? (
                ...
                <div style={{...card,padding:0,overflow:'hidden',marginBottom:'1.5rem'}}>
                  ...
                  <div style={{padding:'20px 24px'}}>
                    ...
                    <button onClick={()=>{setCustomCasinoId(cid);setShowCustomCode(true)}} style={{...btnOutline(accent),padding:'9px 20px',fontSize:13}}>✨ Vreau cod personalizat cu numele meu</button>
                  </div>
                </div>
              ) : gen ? (
                gen.error ? (
                ...
                <div style={{...card,padding:'24px',marginBottom:'1.5rem'}}>
                  ...
                  <div style={{display:'flex',gap:10,flexWrap:'wrap'}}>
                    ...
                    <button onClick={()=>{setCustomCasinoId(cid);setShowCustomCode(true)}} style={{...btnOutline(accent),padding:'12px 20px',fontSize:13}}>✨ Cod personalizat</button>
                  </div>
                </div>
              )}
