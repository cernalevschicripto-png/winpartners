...
const T = {
  ro:{ login:'Conectați-vă', reg:'Înregistrare', home:'Acasă', nav_about:'Despre', nav_ben:'Beneficii', nav_contact:'Contact',
    ...
    how:[['01','Aplici pe WinPartners','Completezi formularul cu datele tale și profilul social. Analizăm cererea în 24-48 ore.'],['02','Primești codul tău promoțional','Codul este unic și legat de tine. Orice jucător care îl folosește devine al tău pe viață.'],['03','Promovezi la audiența ta','Postezi pe TikTok, Instagram, YouTube — cum știi tu mai bine.'],['04','Câștigi automat','Când jucătorii tăi pierd, tu primești 25% din pierderile lor. Săptămânal, în crypto.']],
  ...
  tr:{ login:'Giriş', reg:'Kayıt', home:'Ana Sayfa', nav_about:'Hakkında', nav_ben:'Avantajlar', nav_contact:'İletişim',
    ...
    why_title:'NEDEN BİZ',
    why:[['Hızlı erişim',"Kumarhanelerde onay için günlerce bekleyebilirsiniz. Bizde — 24-48 saat.",'#f5a623'],['Tek panel','Tüm istatistikler, komisyonlar, ödemeler — tek bir yerde.','#60a5fa'],['Kişisel yönetici',"Chatbot değil. Telegram'da cevap veren gerçek bir kişi.",'#10b981'],['Daha iyi komisyonlar','Tüm ortaklarımız için toplu müzakere ederiz.','#a78bfa'],['Garantili ödemeler','Casino ilişkisini biz yönetiriz. Haftalık olarak ödeme alırsınız.','#f59e0b'],['Özel araçlar','Kişisel promosyon kodları, takip bağlantıları, detaylı istatistikler.','#34d399']],
    how_title:'NASIL ÇALIŞIR',
    how:[["01","WinPartners'a başvurun","Verileriniz ve sosyal profilinizle formu doldurun. 24-48 saat içinde inceleriz."],["02","Promosyon kodunuzu alın","Kodunuz benzersiz ve size bağlıdır. Kullanan her oyuncu sonsuza dek sizindir."],["03","Kitlenize tanıtın","TikTok, Instagram, YouTube'da paylaşın."],["04","Otomatik kazanın","Oyuncularınız kaybettiğinde, kayıplarının %25'ini alırsınız. Haftalık, kripto olarak."]],
  ...
  pt:{ login:'Entrar', reg:'Registrar', home:'Início', nav_about:'Sobre', nav_ben:'Benefícios', nav_contact:'Contacto',
    ...
    why:[['Acesso rápido','Nos casinos você pode esperar dias pela aprovação. Conosco — 24-48 horas.','#f5a623'],['Painel único','Todas as estatísticas, comissões, pagamentos — em um só lugar.','#60a5fa'],['Gerente pessoal','Não um chatbot. Uma pessoa real que responde no Telegram.','#10b981'],['Melhores comissões','Negociamos em bloco para todos os nossos parceiros.','#a78bfa'],['Pagamentos garantidos','Gerenciamos o relacionamento com o casino. Você recebe semanalmente.','#f59e0b'],['Ferramentas dedicadas','Códigos promocionais personalizados, links de rastreamento, estatísticas detalhadas.','#34d399']],
    how_title:'COMO FUNCIONA NA PRÁTICA',
    how:[['01','Candidatar-se no WinPartners','Preencha o formulário com seus dados e perfil social. Analisamos em 24-48 horas.'],['02','Receber o seu código promocional','O código é único e vinculado a você. Qualquer jogador que o usar é seu para sempre.'],['03','Promover para o seu público','Publique no TikTok, Instagram, YouTube.'],['04','Ganhar automaticamente','Quando seus jogadores perdem, você recebe 25% das perdas deles. Semanalmente, em cripto.']],
