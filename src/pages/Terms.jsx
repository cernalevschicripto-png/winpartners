    ...
    <div style={{background:'#0a0a0f',minHeight:'100vh',color:'#fff',fontFamily:"'Inter',sans-serif"}}>
      ...
      <div style={{maxWidth:800,margin:'0 auto',padding:'2rem 1rem'}}>
        ...
        {[
          ...
          ['3. Comisioane','Partenerii primesc 25% Revenue Share din veniturile nete generate de jucătorii recomandați, pe toată durata activității acestora. Comisionul se calculează lunar și se plătește săptămânal pentru solduri ce depășesc $30.'],
