...
export default function Benefits() {
  ...
  const gold = '#f5a623'
  const benefits = [
    {icon:'💰',t:'Comision RevShare 20%',d:'Primiți 20% din veniturile nete generate de jucătorii recomandați pe toată durata activității lor. Fără limită de timp, fără reduceri.'},
