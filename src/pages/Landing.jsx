...
const T = {
  ...
  tr: {
    ...
    hex1v:'6', hex1l:'Casino ortakları', hex2v:'10K+', hex2l:'Aktif oyuncular', hex3v:'$2K+', hex3l:'Ort. aylık gelir',
    ...
    b1t:'%25 RevShare Komisyon', b1d:'Önerilen oyuncuların net gelirinin %25’ini ömür boyu alın.',
  ...
  de: {
    ...
    hex1v:'6', hex1l:'Casino-Partner', hex2v:'10K+', hex2l:'Aktive Spieler', hex3v:'$2K+', hex3l:'Durchschn. Monatseinkommen',
    ...
    b1t:'25% RevShare Provision', b1d:'Erhalten Sie 25% des Nettoumsatzes von empfohlenen Spielern lebenslang.',
  ...
  pt: {
    ...
    hex1v:'6', hex1l:'Parceiros casino', hex2v:'10K+', hex2l:'Jogadores ativos', hex3v:'$2K+', hex3l:'Renda mensal média',
    ...
    b1t:'25% Comissão RevShare', b1d:'Receba 25% da receita líquida de jogadores indicados para sempre.',
  ...
  pl: {
    ...
    hex1v:'6', hex1l:'Partnerzy casino', hex2v:'10K+', hex2l:'Aktywni gracze', hex3v:'$2K+', hex3l:'Śr. miesięczny dochód',
    ...
    b1t:'25% Prowizja RevShare', b1d:'Otrzymuj 25% przychodów netto od poleconych graczy dożywotnio.',
